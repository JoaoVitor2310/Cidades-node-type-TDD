...
export const getAll = async (req: Request<{}, {}, {}, IQueryProps>, res: Response) => {
  ...
  const result = await PeopleProvider.getAll(req.query.page || 1, req.query.limit || 10, req.query.filter || '');

  const count = await PeopleProvider.count(req.query.filter); // Identifica quantos resultados encontrou, para mostrar ao usuário
